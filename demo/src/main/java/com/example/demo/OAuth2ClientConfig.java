...
public class OAuth2ClientConfig {
    ...
    @Bean
    @ConditionalOnProperty(prefix = "spring.security.oauth2.client.registration.google", name = { "client-id", "client-secret" })
    public ClientRegistrationRepository clientRegistrationRepository(Environment env) {
        ...
        // If properties are set (the ConditionalOnProperty should ensure this) build the registration
